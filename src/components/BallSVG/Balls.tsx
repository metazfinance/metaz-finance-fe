...
export const PinkBall: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
...
export const LilacBall: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const TealBall: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const AquaBall: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const GreenBall: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const YellowBall: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const BallText = styled(Text)<{ rotationTransform?: number }>`
  color: #000000;
  text-shadow: -0.75px -0.75px 0 white, 0.75px -0.75px 0 white,
    -0.75px 0.75px 0 white, 0.75px 0.75px 0 white;
...
export const BallWithNumber: React.FC<
  React.PropsWithChildren<BallWithNumberProps>
> = ({ color, number, size, fontSize, rotationTransform }) => {
