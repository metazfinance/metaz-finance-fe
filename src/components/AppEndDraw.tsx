...
import { BuyTicketsButton, BuyTicketsButton2 } from "./BuyTickets";
...
export const AppEndDraw = ({ blockEnd, blockStart }: AppNextDrawProps) => {
...
export const AppEndDraw2 = ({ blockEnd, blockStart }: AppNextDrawProps) => {
  const [timer, setTimer] = useState(0);
  const provider = new ethers.providers.JsonRpcProvider(PUBLIC_RPC);
