...
import type {
  StakingToValidator,
  StakingToValidatorInterface,
} from "../StakingToValidator";
...
export class StakingToValidator__factory {
  static readonly abi = _abi;
  static createInterface(): StakingToValidatorInterface {
    return new utils.Interface(_abi) as StakingToValidatorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StakingToValidator {
    return new Contract(address, _abi, signerOrProvider) as StakingToValidator;
  }
}
